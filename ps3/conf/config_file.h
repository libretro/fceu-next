...
// Extracts a single char. If value consists of several chars, this is an error.
bool config_get_char(config_file_t *conf, const char *entry, char *in);
// Extracts a char array. If value consists of several chars, this is an error.
bool config_get_char_array(config_file_t *conf, const char *key, char * in, size_t size_in);
...
void config_set_uint(config_file_t *conf, const char *entry, unsigned val);
...
bool config_string_exists(config_file_t *conf, const char *key, char * str);
