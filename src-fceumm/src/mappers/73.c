 ...
 *  Copyright (C) 2002-2012 Xodnizel, Zeromus
 *
...
static DECLFW(Mapper73_write)
{
  switch(A&0xF000)
  {
    case 0x8000: IRQr&=0xFFF0;IRQr|=(V&0xF)<<0;  break;
    case 0x9000: IRQr&=0xFF0F;IRQr|=(V&0xF)<<4;  break;
    case 0xa000: IRQr&=0xF0FF;IRQr|=(V&0xF)<<8;  break;
    case 0xb000: IRQr&=0x0FFF;IRQr|=(V&0xF)<<12; break;
    case 0xc000:
      IRQm=V&4;
      IRQx=V&1;
      IRQa=V&2;
