...
static item items_generalsettings[MAX_NO_OF_CONTROLS_SETTINGS] =
{
	...
	},
	{
		...
		YELLOW,
		WHITE,
		"INFO - [Game Genie] is set to 'OFF'.",
		LIGHTBLUE,
		0.86f,
		0.09f,
		0.83f,
		&Settings.FCEUGameGenie,
		"INFO - [Game Genie] is set to 'ON'.\nNOTE: Game Genie ROM must be called 'gg.rom' and has to be in the USRDIR directory.",
		"INFO - [Game Genie] is set to 'OFF'",
		0,
		1
	},
	{
		...
		YELLOW,
		WHITE,
		"INFO - Map the face buttons of the NES joystick differently\n depending on personal preference.",
		LIGHTBLUE,
		0.86f,
		0.09f,
		0.83f,
		&Settings.FCEUControlstyle,
		{0},
		{0},
		0,
		1
	},
	{
		...
		YELLOW,
		GREEN,
		"INFO - Set [all FCEU settings] back to their 'DEFAULT' values.",
		LIGHTBLUE,
		0.91f,
		0.09f,
		0.83f,
	...
	{
		SETTING_FCEU_PALETTE, 
		"FCEU Palette", 
		0.0f,
		0.0f,
		YELLOW,
		WHITE,
		"INFO - Select a color palette from the list.",
		LIGHTBLUE,
		0.86f,
		0.09f,
		0.83f,
...
#if 0
	{
		SETTING_FCEU_SCANLINE_NTSC_START, 
		"NTSC Scanline Start", 
		0.0f,
		0.0f,
		YELLOW,
		WHITE,
		"INFO - Set the first scanline to render in NTSC mode.",
		LIGHTBLUE,
		0.86f,
		0.09f,
		0.83f,
	...
	{
		SETTING_FCEU_SCANLINE_NTSC_END, 
		"NTSC Scanline End", 
		0.0f,
		0.0f,
		YELLOW,
		WHITE,
		"INFO - Set the last scanline to render in NTSC mode.",
		LIGHTBLUE,
		0.86f,
		0.09f,
		0.83f,
	...
	{
		SETTING_FCEU_SCANLINE_PAL_START, 
		"PAL Scanline Start", 
		0.0f,
		0.0f,
		YELLOW,
		WHITE,
		"INFO - Set the first scanline to render in PAL mode.",
		LIGHTBLUE,
		0.86f,
		0.09f,
		0.83f,
	...
	{
		SETTING_FCEU_SCANLINE_PAL_END, 
		"PAL Scanline End", 
		0.0f,
		0.0f,
		YELLOW,
		WHITE,
		"INFO - Set the last scanline to render in PAL mode.",
		LIGHTBLUE,
		0.86f,
		0.09f,
		0.83f,
...
#endif
	{
		...
		YELLOW,
		WHITE,
		"INFO - [Sprite Limit] is set to 'ON'.",
		LIGHTBLUE,
		0.86f,
		0.09f,
		0.83f,
		&Settings.FCEUDisableSpriteLimitation,
		"INFO - [Sprite Limit] is set to 'ON'.",
		"INFO - [Sprite Limit] is set to 'OFF'. Less sprite flickering will be\nnoticeable.",
		0,
		1
	},
	{
		...
		YELLOW,
		GREEN,
		"INFO - Set all [FCEU Video Settings] back to their 'DEFAULT' values.",
		LIGHTBLUE,
		0.86f,
		0.09f,
		0.83f,
	...
	},
	{
		...
		YELLOW,
		GREEN,
		"INFO - Set [all FCEU Audio settings] back to their 'DEFAULT' values.",
		LIGHTBLUE,
		0.91f,
		0.09f,
		0.83f,
	...
	},
	{
		...
		YELLOW,
		WHITE,
		"INFO - Set the default [Base directory] path. Miscellaneous files\nnwill be stored here. ",
		LIGHTBLUE,
		0.86f,
		0.09f,
		0.83f,
